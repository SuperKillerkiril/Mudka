...
public class MyUserTaskService
{
    ...
    public List<UserTask> GetUserTasks(int quantity)
    {
    ...
    public void RedactUserTaskById(string id, UserTask userTask) //Редактирование по Id
    {
        var index = UserTasks.FindIndex(t => t.Id == id);
